class AdminEstablishmentsController < AdminController
  ...
  private
    ...
    def establishment_params
      params.require(:establishment).permit(:name, :address, :description, :phone, :latitude, :longitude, :logo, :cover, :email, :password, :password_confirmation, :daily_point_limit)
    end
end
